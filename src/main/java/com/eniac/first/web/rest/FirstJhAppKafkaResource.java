...
import com.eniac.first.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/first-jh-app-kafka")
public class FirstJhAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FirstJhAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public FirstJhAppKafkaResource(KafkaProperties kafkaProperties) {
